  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/30 selection:text-primary">
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-28 pb-40 overflow-hidden bg-background">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/5 border border-white/10 text-primary text-[10px] font-black uppercase tracking-[0.3em] mb-12 animate-fade-in shadow-2xl shadow-black/20">
              <Sparkles className="h-3.5 w-3.5" />
              BMSCE Curated Resources
            </div>
            
            <h1 className="text-7xl md:text-[10rem] font-black mb-10 tracking-tighter animate-fade-in [animation-delay:200ms] leading-[0.8] text-foreground">
              Empowering<br/>
              <span className="italic font-serif text-primary">Excellence.</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-16 leading-relaxed animate-fade-in [animation-delay:400ms] font-serif italic opacity-70">
            ...
            {/* Live Stats Bar */}
            <div className="flex flex-wrap items-center justify-center gap-12 mb-16 animate-fade-in [animation-delay:500ms]">
              <div className="flex flex-col items-center">
                <span className="text-4xl font-black text-foreground tabular-nums tracking-tighter">100+</span>
                <span className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] mt-2">Verified Resources</span>
              </div>
              <div className="w-px h-12 bg-white/10 hidden sm:block"></div>
              <div className="flex flex-col items-center">
                <span className="text-4xl font-black text-foreground tabular-nums tracking-tighter">24/7</span>
                <span className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] mt-2">Uptime Availability</span>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in [animation-delay:600ms]">
              <Button size="lg" className="h-14 px-12 rounded-2xl bg-primary hover:bg-primary/90 text-primary-foreground font-black group shadow-2xl shadow-primary/30 transition-all hover:scale-105 active:scale-95" onClick={() => document.getElementById('semesters')?.scrollIntoView({ behavior: 'smooth' })}>
                Explore Repository
                <ArrowRight className="ml-3 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button size="lg" variant="outline" className="h-14 px-12 rounded-2xl border-white/10 hover:bg-white/5 font-black transition-all shadow-xl">
        ...
        <section className="container mx-auto px-6 mb-32">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-primary/20 transition-all group">
        ...
        {/* Semesters Section */}
        <section id="semesters" className="container mx-auto px-6 mb-32 scroll-mt-24">
          <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-6 text-center md:text-left">
            <div>
              <h2 className="text-3xl md:text-4xl font-black mb-3">Course Catalog</h2>
        ...
        <section className="container mx-auto px-6 mb-24">
          <div className="rounded-[40px] p-8 md:p-16 bg-gradient-to-br from-indigo-500/5 via-background to-primary/5 border border-border/40 relative overflow-hidden group shadow-2xl">
            {/* Background design */}
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 text-center md:text-left">
              <div className="max-w-2xl">
                ...
                <h2 className="text-4xl md:text-6xl font-black mb-8 leading-[0.95] tracking-tighter uppercase font-serif">
                  Stay updated with latest <span className="italic italic-none block md:inline text-primary">academic shifts.</span>
                </h2>
                
                <p className="text-xl text-muted-foreground font-medium opacity-70 leading-relaxed max-w-xl mx-auto md:mx-0">
