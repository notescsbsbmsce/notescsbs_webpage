...
const ContributorCard = ({ contributor, index }: { contributor: Contributor; index: number }) => (
  <div 
    className={`group relative p-12 md:p-16 rounded-[60px] bg-card border border-border hover:border-primary/30 transition-all duration-700 hover:shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-10 delay-${index * 200}`}
  >
    ...
    <div className="flex-1 relative z-10 text-center md:text-left">
      <div className="flex flex-col md:flex-row md:items-center gap-4 mb-4">
        <h3 className="text-3xl md:text-4xl font-black text-foreground tracking-tighter uppercase font-serif italic leading-none group-hover:text-primary transition-colors duration-500">
          {contributor.name}
        </h3>
...
export default function Contributors() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans selection:bg-primary/20 selection:text-primary transition-colors duration-300">
      ...
      <main className="flex-1 container mx-auto px-6 py-12 max-w-6xl animate-fade-in">
        ...
        {/* Hero Section */}
        <header className="relative p-12 md:p-20 rounded-[60px] bg-card border border-border overflow-hidden shadow-2xl mb-16">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl md:text-8xl font-black mb-8 tracking-tighter uppercase font-serif text-foreground leading-[0.9]">
              Meet the <span className="italic italic-none block">Makers of NOTESCSBS</span>
            </h1>
            
            <p className="text-xl text-muted-foreground max-w-3xl leading-relaxed font-medium opacity-80">
        ...
        {/* Closing Statment */}
        <div className="relative p-12 rounded-[50px] border border-dashed border-border flex flex-col items-center justify-center text-center space-y-6 bg-muted/10 overflow-hidden">
